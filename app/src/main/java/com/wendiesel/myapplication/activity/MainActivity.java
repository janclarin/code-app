...
public class MainActivity extends ActionBarActivity
        implements ListCareerPathFragment.OnListCareerPathListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button button = (Button) findViewById(R.id.btn_example_path_detail);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity.this, CareerPathDetailActivity.class);
    ...
    public class CustomPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case 0:
                    return ListCareerPathFragment.newInstance();
                case 1:
